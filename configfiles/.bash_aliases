...
## Proxmox
alias gpuenable="sed -i 's/^/#/g' /etc/modprobe.d/vfio.conf && pct mount 107 && sed -i 's/#hwaccel/hwaccel/g' /var/lib/lxc/107/rootfs/root/config/config.yaml && pct unmount 107 && pct set 107 --dev1 path=/dev/dri/renderD128,mode=0666 && shutdown -r now"
